        ...
        stage('Push to ECR') {
            steps {
                withCredentials([usernamePassword(
                    ...
                    "C:\\Program Files\\Amazon\\AWSCLIV2\\aws.exe" ecr get-login-password --region ca-central-1 | "C:\\Users\\afree\\AppData\\Local\\Programs\\DockerDesktop\\resources\\bin\\docker.exe" login --username AWS --password-stdin 238086621844.dkr.ecr.ca-central-1.amazonaws.com
